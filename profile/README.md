...
# This week (🔜 **June 2** 🕑) --  **two talks** -- 9:00-11:00 (Miguel) and 14:00-16:00 (Rodrigo):
...
- June 2, **14:00-16:00** -- **room 866** -- **Rodrigo Matos** -- Irreducibility of the Bloch and Fermi varieties on periodic media and connections to spectral theory. (an introduction to [Fermi surface](https://en.wikipedia.org/wiki/Fermi_surface) (Fermi Varieties), Bloch Varieties, and an interface of algebraic geometry, spectral theory and mathematical physics)
...
- June 2, **9:00-11:00**: **Miguel dos Anjos Batista**: [mutually orthogonal latin squares](https://en.wikipedia.org/wiki/Mutually_orthogonal_Latin_squares), their relation to [finite projective planes](https://en.wikipedia.org/wiki/Projective_plane#Finite_projective_planes), and all that
